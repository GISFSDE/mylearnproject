...
public class HttpUtils
{
    ...
    public static JSONObject sendPostRowRequest(String param, String url, String token) throws IOException {
...
//        ) {
            ...
            //设置请求体参数
            StringEntity entity = new StringEntity(JSON.toJSONString(jsonString),"UTF-8");
...
//            }catch (Exception e) {
//                log.error("请求失败参数{}",param);
//                e.printStackTrace();
//                jsonObject= JSONObject.parseObject("{errorMessage:  "+responseBody+e.getCause()+"}");
//                return jsonObject;
//            }
//        } catch (Exception e) {
//            log.error("请求失败参数{}",param);
